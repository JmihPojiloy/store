            ...
            modelBuilder.Entity<BookDto>(action =>
            {
                ...
                action.HasData(
                    new BookDto
                    {
                        ...
                        Description = "This volume with basic programming concepts and techniques, then focuses more particularly on information structures-the representation of information inside a computer, the structural relationships between data elements and how to deal with them efficiently.",
                        Price = 7.19m,
                    },
                    new BookDto
                    {
